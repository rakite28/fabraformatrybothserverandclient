...
def parse_time_string(time_str):
    """Parses a time string (e.g., '1h 30m') into total hours."""
...
def calculate_printer_hourly_rate(printer_data):
    """Calculates the hourly operational cost of a printer."""
    try:
...
def calculate_cogs_values(form_data, printer_data, filament_data):
    """Calculates the Cost of Goods Sold based on form inputs and resource data."""
    try:
